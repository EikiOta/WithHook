    ...
    <div className="mt-4">
      ...
      {editMeaning && (
        <TextFormModal
          ...
          onSave={async (text, isPublic) => {
            const updated = await updateMeaning(editMeaning.meaning_id, text, isPublic, userId);
            setMeanings((prev) =>
      ...
      {deleteMeaningTarget && (
        <ConfirmModal
          ...
          onConfirm={async () => {
            await deleteMeaning(deleteMeaningTarget.meaning_id, userId);
            setMeanings((prev) =>
      ...
      {editMemoryHook && (
        <TextFormModal
          ...
          onSave={async (text, isPublic) => {
            const updated = await updateMemoryHook(editMemoryHook.memory_hook_id, text, isPublic, userId);
            setMemoryHooks((prev) =>
      ...
      {deleteMemoryHookTarget && (
        <ConfirmModal
          ...
          onConfirm={async () => {
            await deleteMemoryHook(deleteMemoryHookTarget.memory_hook_id, userId);
            setMemoryHooks((prev) =>
